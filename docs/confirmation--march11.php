...
{
    $email = base64_decode(trim($_GET['a']));
    $password = base64_decode(trim($_GET['b']));
    $confirmation_link = base64_decode(trim($_GET['c'])); 
}
else
{
                      ...
                      <tbody>
                        <tr>
                          <td style="padding: 20px 0px 30px; color: rgb(21, 54, 67); font-family: Arial,sans-serif; line-height: 20px; font-size: 15px;">
                            <p>
                                Thank you for registering with COLCOM. Please click the link below to complete your registration.
                                <br />
                                &nbsp;&nbsp;&nbsp;&nbsp;<a href="<?php echo $confirmation_link; ?>">Verify account.</a>
                                <br /><br />
                                You can find your credentials below:
                                <br />&nbsp;&nbsp;&nbsp;&nbsp;Username: <b style="text-decoration: none;"><?php echo $email; ?></b>
                                <br />&nbsp;&nbsp;&nbsp;&nbsp;Password: <b><?php echo $password; ?></b>
                                <br /><br /><br /><br /><br />                            
                                <font size="-2">
                                  <b>
